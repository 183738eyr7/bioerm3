...
<div class="card col-sm-8">
  <div class="card-body">
  	<h1>
      <center><span>
          <div class="col-md-8">☄ S T R I P E CHECKER ☄</center>
    </h1>
   <div class="md-form">
  	 <div class="col-md-12">
  	 &nbsp&nbsp&nbsp
       <textarea  id="lista" style="width: 100%;height: 300px;resize: none; background-color:white transparent;border: 1px solid black;color:black; "></textarea>
	 </div>
	</div>
    <br>
<center>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">
    	<a href="" class="btn btn-secondary active" role="button" aria-pressed="true">🔥 C H I L L Z 🔥  and  L E V N A R </a>
